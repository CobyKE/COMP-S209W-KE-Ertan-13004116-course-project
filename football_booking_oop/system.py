...
class BookingSystem:
    def __init__(self):
        self.__fields = []          # List of all Field objects
        self.__users = []           # List of all User objects (Customers and Admins)
        self.__bookings = []        # List of all Booking objects
...
main.py – With English Annotations
python
